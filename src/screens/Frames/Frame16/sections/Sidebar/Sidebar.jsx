  ...
  return (
    <div className="flex flex-col w-72 h-[1579px] items-start absolute top-0 left-0 bg-white border-r-4 [border-right-style:solid] border-[#2b2622]">
      ...
      <div className="flex flex-col w-[284px] items-start gap-2 pt-5 pb-0 px-5 relative flex-1 grow">
        ...
        <button className="all-[unset] box-border border-transparent flex h-[60px] items-center gap-4 pl-5 pr-0 py-0 relative self-stretch w-full rounded-2xl border-2 border-solid">
          <img
            className="relative w-6 h-6"
            alt="Icon"
        ...
        <button className="all-[unset] box-border bg-[#ef473a] border-[#2b2622] shadow-[3px_3px_0px_#2b2622b2] flex h-[60px] items-center gap-4 pl-5 pr-0 py-0 relative self-stretch w-full rounded-2xl border-2 border-solid">
          <img
            className="relative w-6 h-6"
            alt="Icon"
