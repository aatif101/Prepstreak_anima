...
export const Sidebar = () => {
  ...
  return (
    <div className="flex w-72 h-[1116.53px] relative flex-col items-start bg-white border-r-4 [border-right-style:solid] border-[#2b2622]">
      <div className="flex flex-col w-[284px] h-[223px] items-start gap-6 pt-8 pb-[3px] px-8 relative border-b-[3px] [border-bottom-style:solid] border-[#2b2622]">
        <div className="relative self-stretch w-full h-10">
          ...
          <img
            ...
            src="https://c.animaapp.com/t0YsFa98/img/prepstreaklogo.svg"
          />
        </div>
        ...
        <div className="flex h-[92px] items-center gap-4 pl-4 pr-0 py-0 relative self-stretch w-full bg-[#f5ebe0] rounded-2xl border-2 border-solid border-[#2b2622]">
          <img
            ...
            alt="Container"
            src="https://c.animaapp.com/t0YsFa98/img/container.svg"
          />
      ...
      <div className="flex flex-col w-[284px] items-start gap-2 pt-5 pb-0 px-5 relative flex-1 grow">
        <button onClick={() => navigate('/dashboard')} className="all-[unset] box-border h-[60px] gap-4 pl-5 pr-0 py-0 self-stretch bg-[#ef473a] rounded-2xl border-2 border-solid border-[#2b2622] shadow-[3px_3px_0px_#2b2622b2] flex items-center relative w-full cursor-pointer">
          <img
            ...
            alt="Icon"
            src="https://c.animaapp.com/t0YsFa98/img/icon.svg"
          />
        ...
        <button onClick={() => navigate('/test/setup/step1')} className="all-[unset] box-border flex h-[60px] items-center gap-4 pl-5 pr-0 py-0 relative self-stretch w-full rounded-2xl border-2 border-solid border-transparent cursor-pointer hover:bg-[#f5ebe0] transition-colors">
          <img
            className="relative w-6 h-6"
            alt="Icon"
            src="https://c.animaapp.com/t0YsFa98/img/icon-1.svg"
          />
        ...
        <button onClick={() => navigate('/quiz/setup/step1')} className="all-[unset] box-border flex h-[60px] items-center gap-4 pl-5 pr-0 py-0 relative self-stretch w-full rounded-2xl border-2 border-solid border-transparent cursor-pointer hover:bg-[#f5ebe0] transition-colors">
          <img
            className="relative w-6 h-6"
            alt="Icon"
            src="https://c.animaapp.com/t0YsFa98/img/icon-2.svg"
          />
        ...
        <button onClick={() => navigate('/badges')} className="all-[unset] box-border h-[60px] gap-4 pl-5 pr-0 py-0 self-stretch rounded-2xl border-2 border-solid border-transparent flex items-center relative w-full cursor-pointer hover:bg-[#f5ebe0] transition-colors">
          <img
            className="relative w-6 h-6"
            alt="Icon"
            src="https://c.animaapp.com/t0YsFa98/img/icon-3.svg"
          />
        ...
        <button onClick={() => navigate('/profile')} className="all-[unset] box-border flex h-[60px] items-center gap-4 pl-5 pr-0 py-0 relative self-stretch w-full rounded-2xl border-2 border-solid border-transparent cursor-pointer hover:bg-[#f5ebe0] transition-colors">
          <img
            className="relative w-6 h-6"
            alt="Icon"
            src="https://c.animaapp.com/t0YsFa98/img/icon-4.svg"
          />
      ...
      <div className="flex flex-col w-[284px] h-[103px] items-start pt-[23px] pb-0 px-5 relative border-t-[3px] [border-top-style:solid] border-[#2b2622]">
        <button onClick={() => navigate('/')} className="all-[unset] box-border flex h-[60px] items-center gap-4 pl-5 pr-0 py-0 relative self-stretch w-full rounded-2xl border-2 border-solid border-transparent cursor-pointer hover:bg-[#f5ebe0] transition-colors">
          <img
            className="relative w-6 h-6"
            alt="Icon"
            src="https://c.animaapp.com/t0YsFa98/img/icon-5.svg"
          />
